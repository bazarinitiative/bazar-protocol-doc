...
- Bazar protocol use command time to control the protocol version upgrade. Any commmand with specific version that exceed specific time range will be treated as invalid.
